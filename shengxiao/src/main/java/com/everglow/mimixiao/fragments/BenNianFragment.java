...
public class BenNianFragment extends Fragment {
    ...
    public static BenNianFragment getInstance(String paramString,  WrapContentViewPager paramWrapContentViewPager) {
        BenNianFragment yunShiFragment = new BenNianFragment();
...
//    }
    ...
    public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle) {
        View view = paramLayoutInflater.inflate(R.layout.fragment_ben_nian, paramViewGroup, false);
        init(view);
        return view;
    }
}
