...
public class AiQingFragment extends Fragment {
    ...
    public static AiQingFragment getInstance(String paramString, WrapContentViewPager paramWrapContentViewPager) {
        AiQingFragment yunShiFragment = new AiQingFragment();
    ...
    private void refreshUi() {
        ...
        tv03.setText(mUl.get(3).getValue());
...
//    }
    ...
    public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle) {
        View view = paramLayoutInflater.inflate(R.layout.fragment_ai_qing, paramViewGroup, false);
        init(view);
        return view;
    }
}
