...
public class BenZhouFragment extends Fragment {
    ...
    public static BenZhouFragment getInstance(String paramString, WrapContentViewPager paramWrapContentViewPager) {
        BenZhouFragment yunShiFragment = new BenZhouFragment();
...
//    }
    ...
    public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle) {
        View view = paramLayoutInflater.inflate(R.layout.fragment_ben_zhou, paramViewGroup, false);
        init(view);
        return view;
    }
}
