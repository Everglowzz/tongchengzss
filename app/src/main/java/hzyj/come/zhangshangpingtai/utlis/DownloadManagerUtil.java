...
public class DownloadManagerUtil {
     ...
     */
    public void downloadApk(String apkPath, String downloadUrl,  WelcomeActivity.MyProgressListener listener) {
...
//            apkFile.delete();
    ...
    private void startInstall(String apkPath) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            uri = FileProvider.getUriForFile(mContext, mContext.getPackageName()+".fileprovider",
                    new File(apkPath));
