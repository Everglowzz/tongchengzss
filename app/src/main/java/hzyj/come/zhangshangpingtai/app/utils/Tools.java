package hzyj.come.zhangshangpingtai.app.utils;
...
public class Tools {
    ...
    public static String getDataDirectory() {
        ...
        File rootDir = new File(Environment.getDataDirectory().getPath() + File.separator + "zhjyapk");
        if (!rootDir.exists()) {
            rootDir.mkdirs();
        }
    ...
    public static String getExternalStorageDirectory() {
        ...
        File rootDir = new File(Environment.getExternalStorageDirectory().getPath() + File.separator + "zhjyapk");
        if (!rootDir.exists()) {
            rootDir.mkdirs();
        }
    ...
    public static String getFileDir(Context context) {
        String path = "";
        if (context != null) {
            path = context.getFilesDir().getAbsolutePath() + File.separator + "zhjyapk";
